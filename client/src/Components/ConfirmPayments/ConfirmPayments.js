...
const ConfirmPayments = ({setClose,data, text}) => {
    ...
    return <Modal closeModal={setClose}>
        <div className={styles['user-info']}>
                ...
                <div className={styles['user-avatar']}>
                    ...
                    <div className={styles['user-info']}>
                        ...
                        <div className={styles['statuses']}>
                            ...
                            {/*<span className={styles['fcfs']}>Scraps 0/400</span>*/}
                        </div>
                    </div>
                </div>
            ...
            <p className={styles['payments-confirmation-text']}>Your raid is ready to start,please pay {data.budget} SOL to start the raid.</p>
